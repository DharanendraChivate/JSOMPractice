    ...
    <div class="row" style="margin-top: 5%;background-color: #8080803b;">
        <div class="col-sm-3" style="margin-top: 2%; margin-bottom: 1%;">
            <ol>
                ...
                <li style="margin-bottom: 3%;">
                    <button type="button" class="btn btn-primary btn-sm" id="createItemButton">Create Item</button>
                </li>
                <li style="margin-bottom: 3%;">
                    <button type="button" class="btn btn-info btn-sm" id="updateItemButton">Update Item</button>
                </li>
            </ol>
        </div>
